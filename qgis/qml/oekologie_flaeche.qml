...
<qgis simplifyLocal="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyAlgorithm="0" version="3.10.6-A Coruña" maxScale="0" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" symbollevels="0" attr="typ" enableorderby="0">
    <categories>
      <category value="Andere_Massnahme" symbol="0" label="Andere Massnahme" render="true"/>
      <category value="Biotop" symbol="1" label="Biotop" render="true"/>
      <category value="Hochstammobstanlagen" symbol="2" label="Hochstammobstanlagen" render="true"/>
      <category value="Perimeter_Vernetzungsprojekt" symbol="3" label="Perimeter Vernetzungsprojekt" render="true"/>
    </categories>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="2" type="fill" alpha="1">
        <layer class="PointPatternFill" pass="0" locked="0" enabled="1">
          ...
          <symbol clip_to_extent="1" force_rhr="0" name="@2@0" type="marker" alpha="1">
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              <prop k="angle" v="0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" name="3" type="fill" alpha="1">
        <layer class="LinePatternFill" pass="0" locked="0" enabled="1">
          ...
          <symbol clip_to_extent="1" force_rhr="0" name="@3@0" type="line" alpha="1">
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="oekologische_flaechen_b396162a_7225_4525_859f_1f4e013c5650" name="Layer" type="QString"/>
            <Option value="Ökologische Flächen" name="LayerName" type="QString"/>
            <Option value="postgres" name="LayerProviderName" type="QString"/>
            <Option value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;oekologische_flaechen&quot; sql=" name="LayerSource" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="raeumlicheelemnt_klg_flche_projekt_fkey" name="Relation" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="ReadOnly" type="bool"/>
            <Option value="raeumlicheelemnt_klg_flche_werkeigentum_fkey" name="Relation" type="QString"/>
            <Option value="false" name="ShowForm" type="bool"/>
            <Option value="true" name="ShowOpenFormButton" type="bool"/>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="typ" applyOnUpdate="0" expression="'Andere_Massnahme'"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Ökologie Flächen" columnCount="2" groupBox="0" visibilityExpressionEnabled="0">
    ...
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Genossenschaft" columnCount="1" groupBox="0" visibilityExpressionEnabled="0">
      <attributeEditorRelation showLabel="0" showLinkButton="1" showUnlinkButton="1" relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnsmnt_klg_flche_fkey" name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsmnt_klg_flche_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsmnt_klg_flche_fkey">
      <config type="Map">
