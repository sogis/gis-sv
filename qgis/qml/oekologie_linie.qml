...
<qgis simplifyLocal="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyAlgorithm="0" version="3.10.6-A Coruña" maxScale="0" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" symbollevels="0" attr="typ" enableorderby="0">
    <categories>
      <category value="Ausdolung_Gewaesser" symbol="0" label="Ausdolung Gewässer" render="true"/>
      <category value="Bach_und_Ufervegetation" symbol="1" label="Bach und Ufervegetation" render="true"/>
      <category value="Hecke" symbol="2" label="Hecke" render="true"/>
      <category value="Revitalisierung_Gewaesser" symbol="3" label="Revitalisierung Gewässer" render="true"/>
      <category value="Waldrandaufwertung" symbol="4" label="Waldrandaufwertung" render="true"/>
    </categories>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="" name="FilterExpression" type="QString"/>
            <Option value="ilicode" name="Key" type="QString"/>
            <Option value="oekologie_linien_1d2952f4_a371_4cf9_8fce_1076edddfe7e" name="Layer" type="QString"/>
            <Option value="Ökologie Linien" name="LayerName" type="QString"/>
            <Option value="postgres" name="LayerProviderName" type="QString"/>
            <Option value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;oekologie_linien&quot; sql=" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="UseCompleter" type="bool"/>
            <Option value="dispname" name="Value" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="raeumlicheelemnte_klg_lnie_projekt_fkey" name="Relation" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="ReadOnly" type="bool"/>
            <Option value="raeumlicheelemnte_klg_lnie_werkeigentum_fkey" name="Relation" type="QString"/>
            <Option value="false" name="ShowForm" type="bool"/>
            <Option value="true" name="ShowOpenFormButton" type="bool"/>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="typ" applyOnUpdate="0" expression="'Revitalisierung_Gewaesser'"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Ökologie Linie" columnCount="2" groupBox="0" visibilityExpressionEnabled="0">
      <attributeEditorField showLabel="1" name="typ" index="3"/>
    ...
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Genossenschaft" columnCount="1" groupBox="0" visibilityExpressionEnabled="0">
      <attributeEditorRelation showLabel="0" showLinkButton="1" showUnlinkButton="1" relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnslmnt_klg_lnie_fkey" name="raemlchlmnt_gsnschft_lment_elemnt_gnssnslmnt_klg_lnie_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnslmnt_klg_lnie_fkey">
      <config type="Map">
