...
<qgis minScale="1e+8" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1" version="3.10.6-A Coruña" labelsEnabled="0" simplifyAlgorithm="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <renderer-v2 type="categorizedSymbol" attr="typ" symbollevels="0" enableorderby="0" forceraster="0">
    <categories>
      <category render="true" symbol="0" value="Beregnungsanlage" label="Beregnungsanlage"/>
      <category render="true" symbol="1" value="Traditionelle_Berieselung" label="Traditionelle Berieselung"/>
      <category render="true" symbol="2" value="Tropfen_Mikrobewaesserung" label="Tropfen Mikrobewaesserung"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="fill" force_rhr="0" name="0" clip_to_extent="1">
        <layer locked="0" enabled="1" class="PointPatternFill" pass="0">
          <prop v="1.75" k="displacement_x"/>
          ...
          <symbol alpha="1" type="marker" force_rhr="0" name="@0@0" clip_to_extent="1">
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <prop v="0" k="angle"/>
              <prop v="119,186,226,255" k="color"/>
      ...
      <symbol alpha="1" type="fill" force_rhr="0" name="2" clip_to_extent="1">
        <layer locked="0" enabled="1" class="PointPatternFill" pass="0">
          ...
          <symbol alpha="1" type="marker" force_rhr="0" name="@2@0" clip_to_extent="1">
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <prop v="0" k="angle"/>
              <prop v="119,186,226,255" k="color"/>
              <prop v="1" k="horizontal_anchor_point"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Layer" value="bewaesserung_flaechen_ea78957c_5b76_4e79_a184_a1146ce39535"/>
            <Option type="QString" name="LayerName" value="Bewässerung Flächen"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;bewaesserung_flaechen&quot; sql="/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Relation" value="raemlchlmnt_blchn_bwssrung_projekt_fkey"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="bool" name="ReadOnly" value="false"/>
            <Option type="QString" name="Relation" value="raemlchlmnt_blchn_bwssrung_werkeigentum_fkey"/>
            <Option type="bool" name="ShowForm" value="false"/>
            <Option type="bool" name="ShowOpenFormButton" value="true"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="typ" name="Typ Bewässerung" index="2"/>
  ...
  <defaults>
    ...
    <default field="typ" applyOnUpdate="0" expression="'Tropfen_Mikrobewaesserung'"/>
  ...
  <constraints>
    ...
    <constraint field="astatus" exp_strength="0" notnull_strength="1" unique_strength="0" constraints="1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" showLabel="1" name="Bewässerung Fläche" visibilityExpressionEnabled="0" columnCount="2" visibilityExpression="">
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" name="Genossenschaft" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="">
      <attributeEditorRelation relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnslchn_bwssrung_fkey" showUnlinkButton="1" showLabel="0" showLinkButton="1" name="raemlchlmnt_gsnschft_lment_elemnt_gnssnslchn_bwssrung_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnslchn_bwssrung_fkey">
      <config type="Map">
