...
<qgis version="3.10.7-A Coruña" hasScaleBasedVisibilityFlag="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions" labelsEnabled="0" minScale="1e+8" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" readOnly="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="categorizedSymbol" attr="typ" enableorderby="0">
    <categories>
      <category value="Abbruch_Leitung" symbol="0" render="true" label="Abbruch Leitung"/>
      <category value="Freileitung" symbol="1" render="true" label="Freileitung"/>
      <category value="Kabel_unterirdisch" symbol="2" render="true" label="Kabel unterirdisch"/>
    </categories>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="elektrizitaet_linien_ade773a7_bdf8_47bf_b93f_6638e5860c6a" name="Layer" type="QString"/>
            <Option value="Elektrizität Linien" name="LayerName" type="QString"/>
            <Option value="postgres" name="LayerProviderName" type="QString"/>
            <Option value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;elektrizitaet_linien&quot; sql=" name="LayerSource" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="raeumlicheelemnte_ev_linie_projekt_fkey" name="Relation" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="ReadOnly" type="bool"/>
            <Option value="raeumlicheelemnte_ev_linie_werkeigentum_fkey" name="Relation" type="QString"/>
            <Option value="false" name="ShowForm" type="bool"/>
            <Option value="true" name="ShowOpenFormButton" type="bool"/>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default expression="'Kabel_unterirdisch'" field="typ" applyOnUpdate="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="2" groupBox="0" name="Elektrizitätsversorgung Linie" visibilityExpressionEnabled="0" showLabel="1" visibilityExpression="">
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" name="Genossenschaft" visibilityExpressionEnabled="0" showLabel="1" visibilityExpression="">
      <attributeEditorRelation name="raemlchlmnt_gsnschft_lment_elemnt_gnssnschlmnt_v_lnie_fkey" showUnlinkButton="1" showLabel="0" showLinkButton="1" relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnschlmnt_v_lnie_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnschlmnt_v_lnie_fkey">
      <config type="Map">
