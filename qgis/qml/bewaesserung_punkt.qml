...
<qgis minScale="1e+8" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="0" version="3.10.6-A Coruña" labelsEnabled="0" simplifyAlgorithm="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <renderer-v2 type="categorizedSymbol" attr="typ" symbollevels="0" enableorderby="0" forceraster="0">
    <categories>
      <category render="true" symbol="0" value="Fassung_Entsander" label="Fassung / Entsander"/>
      <category render="true" symbol="1" value="Pumpwerk" label="Pumpwerk"/>
      <category render="true" symbol="2" value="Speicher" label="Speicher"/>
    </categories>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Layer" value="bewaesserung_punkte_5ead88d4_f69e_4219_a559_7e31e57b16d4"/>
            <Option type="QString" name="LayerName" value="Bewässerung Punkte"/>
            <Option type="QString" name="LayerProviderName" value="postgres"/>
            <Option type="QString" name="LayerSource" value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;bewaesserung_punkte&quot; sql="/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Relation" value="raeumlichlmnt_bwssrng_pnkt_projekt_fkey"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option type="bool" name="OrderByValue" value="true"/>
            <Option type="bool" name="ReadOnly" value="false"/>
            <Option type="QString" name="Relation" value="raeumlichlmnt_bwssrng_pnkt_werkeigentum_fkey"/>
            <Option type="bool" name="ShowForm" value="false"/>
            <Option type="bool" name="ShowOpenFormButton" value="true"/>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="typ" applyOnUpdate="0" expression="'Speicher'"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer groupBox="0" showLabel="1" name="Bewässerung Punkt" visibilityExpressionEnabled="0" columnCount="2" visibilityExpression="">
    ...
    <attributeEditorContainer groupBox="0" showLabel="1" name="Genossenschaft" visibilityExpressionEnabled="0" columnCount="1" visibilityExpression="">
      <attributeEditorRelation relation="raemlchlmnt_gsnschft_lment_elemnt_gnssns_bwssrng_pnkt_fkey" showUnlinkButton="1" showLabel="0" showLinkButton="1" name="raemlchlmnt_gsnschft_lment_elemnt_gnssns_bwssrng_pnkt_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssns_bwssrng_pnkt_fkey">
      <config type="Map">
