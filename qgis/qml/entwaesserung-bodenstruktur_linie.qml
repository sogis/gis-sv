...
<qgis simplifyLocal="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyAlgorithm="0" version="3.10.6-A Coruña" maxScale="0" minScale="1e+8" simplifyDrawingTol="1" labelsEnabled="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" symbollevels="0" attr="typ" enableorderby="0">
    <categories>
      <category value="Drainageleitung_perforiert" symbol="0" label="Drainageleitung perforiert" render="true"/>
      <category value="Entwaesserungsgraben" symbol="1" label="Entwaesserungsgraben" render="true"/>
      <category value="Hauptleitung_Ableitung" symbol="2" label="Hauptleitung Ableitung" render="true"/>
    </categories>
    <symbols>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="entw_bodenstruktur_linien_d1f1b635_b504_4c80_b9d0_677f4e789fe3" name="Layer" type="QString"/>
            <Option value="Entwässerung und Bodenstruktur Linien" name="LayerName" type="QString"/>
            <Option value="postgres" name="LayerProviderName" type="QString"/>
            <Option value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;entw_bodenstruktur_linien&quot; sql=" name="LayerSource" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="raemlchlmnt_ndnstrktr_lnie_projekt_fkey" name="Relation" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="ReadOnly" type="bool"/>
            <Option value="raemlchlmnt_ndnstrktr_lnie_werkeigentum_fkey" name="Relation" type="QString"/>
            <Option value="false" name="ShowForm" type="bool"/>
            <Option value="true" name="ShowOpenFormButton" type="bool"/>
          </Option>
        </config>
  ...
  <defaults>
    ...
    <default field="typ" applyOnUpdate="0" expression="'Hauptleitung_Ableitung'"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Entwässerung Bodenstruktur Linie" columnCount="2" groupBox="0" visibilityExpressionEnabled="0">
    ...
    <attributeEditorContainer showLabel="1" visibilityExpression="" name="Genossenschaft" columnCount="1" groupBox="0" visibilityExpressionEnabled="0">
      <attributeEditorRelation showLabel="0" showLinkButton="1" showUnlinkButton="1" relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnsdnstrktr_lnie_fkey" name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsdnstrktr_lnie_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsdnstrktr_lnie_fkey">
      <config type="Map">
