...
<qgis version="3.10.7-A Coruña" hasScaleBasedVisibilityFlag="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions" labelsEnabled="0" minScale="1e+8" simplifyMaxScale="1" maxScale="0" simplifyDrawingTol="1" readOnly="0" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="categorizedSymbol" attr="typ" enableorderby="0">
    <categories>
      <category value="Aufbereitungsanlage" symbol="0" render="true" label="Aufbereitungsanlage"/>
      <category value="Fernwirkanlage" symbol="1" render="true" label="Fernwirkanlage"/>
      <category value="Grundwasserfassung" symbol="2" render="true" label="Grundwasserfassung"/>
      <category value="Pumpwerk" symbol="3" render="true" label="Pumpwerk"/>
      <category value="Quellfassung_inkl_Brunnenstube" symbol="4" render="true" label="Quellfassung inkl Brunnenstube"/>
      <category value="Reservoir" symbol="5" render="true" label="Reservoir"/>
      <category value="Traenkeanlage" symbol="6" render="true" label="Traenkeanlage"/>
    </categories>
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" name="6" force_rhr="0" type="marker">
        <layer locked="0" class="SimpleMarker" enabled="1" pass="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
  ...
  <customproperties>
    <property key="dualview/previewExpressions">
      <value>represent_value(typ) || COALESCE(' (' || t_id || ')','')</value>
    </property>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="wasserversorgung_punkte_4ecbac9b_c9c5_4bb3_9f0d_7fd984cab353" name="Layer" type="QString"/>
            <Option value="Wasserversorgung Punkte" name="LayerName" type="QString"/>
            <Option value="postgres" name="LayerProviderName" type="QString"/>
            <Option value="service='edit' key='itfcode' checkPrimaryKeyUnicity='1' table=&quot;alw_strukturverbesserungen&quot;.&quot;wasserversorgung_punkte&quot; sql=" name="LayerSource" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="raemlchlmnt_wrvrsrgng_pnkt_projekt_fkey" name="Relation" type="QString"/>
      ...
      <editWidget type="RelationReference">
        <config>
          <Option type="Map">
            ...
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="ReadOnly" type="bool"/>
            <Option value="raemlchlmnt_wrvrsrgng_pnkt_werkeigentum_fkey" name="Relation" type="QString"/>
            <Option value="false" name="ShowForm" type="bool"/>
            <Option value="true" name="ShowOpenFormButton" type="bool"/>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="bautyp" index="3" name="Bautyp"/>
    <alias field="astatus" index="4" name="Status"/>
    <alias field="status_datum" index="5" name="Datum Status"/>
    <alias field="bauabnahme_datum" index="6" name="Datum Bauabnahme"/>
    <alias field="werksid" index="7" name="WerksID"/>
    <alias field="unterhaltsid" index="8" name="UnterhaltsID"/>
    <alias field="projekt" index="9" name="Projekt"/>
    <alias field="werkeigentum" index="10" name="Werkeigentum"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="'Quellfassung_inkl_Brunnenstube'" field="typ" applyOnUpdate="0"/>
    <default expression="'Neubau'" field="bautyp" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="5" unique_strength="0" notnull_strength="1" field="status_datum" exp_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="status_datum" exp="status_datum IS NULL or (status_datum >= to_date('1800-01-01') and status_datum &lt;= to_date('2099-12-31'))" desc="status_datum IS NULL or (status_datum >= to_date('1800-01-01') and status_datum &lt;= to_date('2099-12-31'))"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="317" name="typ" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorContainer columnCount="2" groupBox="0" name="Wasserversorgung Punkt" visibilityExpressionEnabled="0" showLabel="1" visibilityExpression="">
      <attributeEditorField name="typ" index="2" showLabel="1"/>
      <attributeEditorField name="bautyp" index="3" showLabel="1"/>
      <attributeEditorField name="astatus" index="4" showLabel="1"/>
      <attributeEditorField name="status_datum" index="5" showLabel="1"/>
      <attributeEditorField name="bauabnahme_datum" index="6" showLabel="1"/>
      <attributeEditorField name="projekt" index="9" showLabel="1"/>
      <attributeEditorField name="werksid" index="7" showLabel="1"/>
      <attributeEditorField name="werkeigentum" index="10" showLabel="1"/>
      <attributeEditorField name="unterhaltsid" index="8" showLabel="1"/>
    ...
    <attributeEditorContainer columnCount="1" groupBox="0" name="Genossenschaft" visibilityExpressionEnabled="0" showLabel="1" visibilityExpression="">
      <attributeEditorRelation name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsrvrsrgng_pnkt_fkey" showUnlinkButton="1" showLabel="0" showLinkButton="1" relation="raemlchlmnt_gsnschft_lment_elemnt_gnssnsrvrsrgng_pnkt_fkey"/>
    </attributeEditorContainer>
  ...
  <widgets>
    <widget name="raemlchlmnt_gsnschft_lment_elemnt_gnssnsrvrsrgng_pnkt_fkey">
      <config type="Map">
