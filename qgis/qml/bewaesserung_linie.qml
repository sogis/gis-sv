...
<qgis version="3.16.0-Hannover" styleCategories="Symbology">
  <renderer-v2 enableorderby="0" attr="typ" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" label="Kanal" render="true" value="Kanal"/>
      <category symbol="1" label="Stollen" render="true" value="Stollen"/>
      <category symbol="2" label="Verteilleitung" render="true" value="Verteilleitung"/>
      <category symbol="3" label="Zuleitung Bewaesserung" render="true" value="Zuleitung_Bewaesserung"/>
    </categories>
    <symbols>
